...
namespace App\Swagger\Public\Branch;
    /**
     * @OA\Get(
     *     path="/api/{locale}/user/public/branches/{branch_slug}/vendor-data",
     *     tags={"Public - Branch"},
     *     summary="Get Main Data Of vendor",
     *     description="Get Main Data Of vendor",
     *
     *     @OA\Parameter(
     *         name="locale",
     *         in="path",
