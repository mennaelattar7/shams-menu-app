...
namespace App\Swagger\Public\MenuCategory;
/**
 * @OA\Get(
 *     path="/api/{locale}/user/public/menu-categories/{category_slug}/products",
 *     tags={"Public - Product"},
 *     operationId="All Products In one menu category",
 *     summary="---Get All Products In menu category Endpoint---",
 *     description="Get All Products In menu category",
 *
 *     @OA\Parameter(
 *         name="locale",
 *         in="path",
 ...
 *     @OA\Response(
 *         response=200,
 *         description="Get All Products in menu category Successfully",
 *         @OA\JsonContent(
 *             type="object",
