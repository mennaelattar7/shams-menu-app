...
/**
 * @OA\Get(
 *     path="/api/{locale}/user/vendor/users",
 *     tags={"Vendor - User"},
 *     operationId="All users",
 *     summary="---Get All users In Vendor Endpoint---",
 *     description="Get All users In Vendor",
 *
 *     @OA\Parameter(
 *         name="locale",
 *         in="path",
 ...
 *     @OA\Response(
 *         response=200,
 *         description="Get All users in vendor Successfully",
 *         @OA\JsonContent(
 *             type="object",
