...
return new class extends Migration
{
    ...
    {
        Schema::create('shams___product_cooking_levels', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('created_by_id')->unsigned();
            $table->bigInteger('updated_by_id')->unsigned()->nullable();
            $table->bigInteger('deleted_by_id')->unsigned()->nullable();

            $table->string('name')->comment('rare, medium, well-done');
    ...
    {
        Schema::dropIfExists('shams___product_cooking_levels');
    }
};
