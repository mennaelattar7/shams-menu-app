<div class="clearfix row">
    <div class="col-md-6 col-sm-12">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('dashboard.main_dashboard.department.index',['locale'=>app()->getLocale(),'context_url'=>$context_url])}}">
            ...
            @else
                <li class="breadcrumb-item active" aria-current="page">{{ trans('Dashboard.New_department')}}</li>
            @endif
        </ol>
        </nav>
    </div>
