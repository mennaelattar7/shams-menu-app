...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            @include('Dashboard.Main_Dashboard.Department.Single_Item.Content.header')
        </div>
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-md-12" style="text-align: right">
                                @include('Dashboard.Main_Dashboard.Department.Single_Item.Content.main_links')
                            </div>
                        </div>
                        <br>
                        <div class="row">
                           @include('Dashboard.Main_Dashboard.Department.Single_Item.Content.main_dates')
                        </div>
                        <div id="accordion" class="accordion">
                            <div class="card mb-0">
                                <!--main-info-section-->
                                @include('Dashboard.Main_Dashboard.Department.Single_Item.Content.All_Info.index')
                            </div>
                        </div>
