        ...
        <div class="clearfix row">
                ...
                <div class="card">
                    <div class="body">
                        <div class="d-flex align-items-center">
                            <div class="text-white icon-in-bg bg-indigo rounded-circle"><i class="fa fa-briefcase"></i></div>
                            <div class="ml-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <div class="d-flex align-items-center">
                            <div class="text-white icon-in-bg bg-azura rounded-circle"><i class="fa fa-credit-card"></i></div>
                            <div class="ml-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <div class="d-flex align-items-center">
                            <div class="text-white icon-in-bg bg-orange rounded-circle"><i class="fa fa-users"></i></div>
                            <div class="ml-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <div class="d-flex align-items-center">
                            <div class="text-white icon-in-bg bg-pink rounded-circle"><i class="fa fa-life-ring"></i></div>
                            <div class="ml-4">
                    ...
                    <table class="table table-hover table-custom spacing5">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>$1200</td>
                                <td><span class="ml-0 mr-0 badge badge-success">Done</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('shams/dashboard/general_assets/assets/images/xs/avatar2.jpg')}}" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded w35 h35">
                                        <div class="ml-3">
                            ...
                            <tr>
                                ...
                                <td>$451</td>
                                <td><span class="ml-0 mr-0 badge badge-warning">Panding</span></td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-default" title="Send Invoice" data-toggle="tooltip" data-placement="top"><i class="icon-envelope"></i></button>
                                    <button type="button" class="btn btn-sm btn-default " title="Print" data-toggle="tooltip" data-placement="top"><i class="icon-printer"></i></button>
                                    <button type="button" class="btn btn-sm btn-default" title="Delete" data-toggle="tooltip" data-placement="top"><i class="icon-trash"></i></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('shams/dashboard/general_assets/assets/images/xs/avatar5.jpg')}}" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded w35 h35">
                                        <div class="ml-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('shams/dashboard/general_assets/assets/images/xs/avatar6.jpg')}}" data-toggle="tooltip" data-placement="top" title="Avatar Name" alt="Avatar" class="rounded w35 h35">
                                        <div class="ml-3">
            ...
            <div class="col-lg-4 col-md-12">
                <a class="card" href="javascript:void(0)">
                    <div class="text-center body">
                        <img class="img-thumbnail rounded-circle" src="{{ asset('shams/dashboard/general_assets/assets/images/sm/avatar1.jpg')}}" alt="">
                    ...
                    <div class="body">
                        <div class="card-text">
                            ...
                            <div class="mt-4">
                                ...
                                <span>FTP</span>
                                <div class="mb-0 progress progress-xxs">
