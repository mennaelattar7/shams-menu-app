                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card profile-header">
                            <div class="text-center body">
                                <br>
                                @if($vendor->logo)
                                    <img src="{{ $vendor->logo }}" class="rounded-circle" alt="">
                                @else
                                    <div alt="">
                                        <span class="rounded-circle" style="border: 1px solid yellow;padding: 20px;">{{ $initials }}</span>
                                    </div>
                                @endif
                                <br>
                                <div class="mt-3">
                                    ...
                                    <div class="body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <p>Id like to receive the following emails:</p>
